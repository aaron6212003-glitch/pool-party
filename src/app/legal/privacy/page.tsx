        ...
        <div className="min-h-screen bg-black p-6">
            ...
            <Card className="!p-8 bg-zinc-900/40 border-white/5 rounded-[2rem] space-y-6 text-zinc-400 text-sm font-medium leading-relaxed mb-8">
                <section className="space-y-2">
                    <h2 className="text-white font-black text-xs uppercase tracking-widest text-primary">1. Data Collection</h2>
                ...
                <section className="space-y-2">
                    <h2 className="text-white font-black text-xs uppercase tracking-widest text-primary">2. Account Deletion</h2>
                ...
                <section className="space-y-2">
                    <h2 className="text-white font-black text-xs uppercase tracking-widest text-primary">3. User Generated Content</h2>
                ...
                <section className="space-y-2">
                    <h2 className="text-white font-black text-xs uppercase tracking-widest text-primary">4. Third Parties</h2>
