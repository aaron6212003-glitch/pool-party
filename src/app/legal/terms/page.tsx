        ...
        <div className="min-h-screen bg-black p-6">
            ...
            <Card className="!p-8 bg-zinc-900/40 border-white/5 rounded-[2rem] space-y-6 text-zinc-400 text-sm font-medium leading-relaxed">
                <section className="space-y-2">
                    <h2 className="text-white font-black text-xs uppercase tracking-widest">1. Community Rules</h2>
                ...
                <section className="space-y-2">
                    <h2 className="text-white font-black text-xs uppercase tracking-widest">2. Content Monitoring</h2>
                ...
                <section className="space-y-2">
                    <h2 className="text-white font-black text-xs uppercase tracking-widest">3. Financial Accuracy</h2>
                ...
                <section className="space-y-2">
                    <h2 className="text-white font-black text-xs uppercase tracking-widest">4. Account Termination</h2>
